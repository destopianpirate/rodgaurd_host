...
function showSmartTooltip(p, isResolved, e) {
    ...
    tt.innerHTML = `
        <div class="st-header">
            <div class="st-severity" style="color: ${cfg.color}">${cfg.icon} ${cfg.label}</div>
            <div class="st-status ${isResolved ? 'resolved' : 'active'}">${isResolved ? 'RESOLVED' : 'ACTIVE'}</div>
        </div>
        <div class="st-row">
            <span class="st-label">Vehicles Verified:</span>
            <span class="st-val">${p.verified_count}</span>
        </div>
        <div class="st-row">
            <span class="st-label">First Seen:</span>
            <span class="st-val">${firstDate}</span>
        </div>
        <div class="st-row">
            <span class="st-label">Last Verified:</span>
...
async function performSmartSeed() {
    ...
    // Robustly find true live location (with IP fallback)
