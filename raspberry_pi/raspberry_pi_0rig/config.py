...
# IMPORTANT: Replace with your laptop's WiFi IP address.
# Find it by running 'ipconfig' on Windows → look for "IPv4 Address" under WiFi.
# Both Pi and laptop must be on the SAME WiFi network.
...
BUZZER_COOLDOWN = 2.0                # Match the 2-second detection cooldown
